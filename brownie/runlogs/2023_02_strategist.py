...
with TemporaryForkWithVaultStats(votes):
    ...
    # From
    from_strat(MORPHO_COMP_STRAT, [[638_000, dai], [2_618_000, usdc]])
    from_strat(MORPHO_AAVE_STRAT, [[1_900_000, usdt]])
        
    # Swap

    # To
    to_strat(MORPHO_AAVE_STRAT, [[638_000, dai], [837_000, usdc]])
    to_strat(OUSD_METASTRAT, [[1_781_000, usdc], [1_900_000, usdt]])
